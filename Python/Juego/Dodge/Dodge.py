...
while running:      # Startup menu
    ...
    normal_i = ft.render('Jugar',1,(0,0,0)),ft.size('Jugar')
...
while running:      # Main game loop
    ...
    while 1:        # Level loop
        ...
        try:    # Draw text
            msg_hp = font1.render('Tienes %i vidas'%(player1[2]),1,(0,0,0))
            screen.blit(msg_hp,(15,15))

            msg_lv = font1.render('Nivel '+str(level),1,(0,0,0))
            screen.blit(msg_lv,(15,50))

            msg_pts = font1.render('Puntaje: '+str(points),1,(0,0,0))
        ...
        if player1[2] < 1:  # Player has died
            ...
            if running == 4:
                ask1 = font1.render("Seguir Jugando?",0,(0,0,0))
                screen.blit(ask1,(400,300))
                int1 = font1.render("En el metodo de Bisccion, se escoje:",0,(0,0,0))
                screen.blit(int1,(400, 380))
                resi = font1.render("Flecha Izquierda",0,(0,0,0))
                screen.blit(resi,(200,430))
                resd = font1.render("Flecha Derecha",0,(0,0,0))
                screen.blit(resd,(600,430))
                flcd = font1.render("El valor Mas Cercano a cero",0,(0,0,0))
                flci = font1.render("El valor Mas Lejano a cero",0,(0,0,0))
                screen.blit(flci,(200,500))
                screen.blit(flcd,(600,500))
